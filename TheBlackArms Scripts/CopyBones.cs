...
#if UNITY_EDITOR
public class CopyBones : EditorWindow
{
	...
	[MenuItem("Alpines/Utilities/CopyBones")]
	static void Init()
	{
	...
	public void OnGUI()
	{
		...
		{
			CopyBonesTOSMR(SelectedObject,CopyFromObject);
		}
	...
	public bool CopyBonesTOSMR(GameObject GO, GameObject GO2)
	{
		if(!GO)
		{
		...
		SkinnedMeshRenderer SMR2=GO2.GetComponent<SkinnedMeshRenderer>();

		if(SMR && SMR2)
		{
			SMR.bones=SMR2.bones;
		}
