...
#if UNITY_EDITOR
public class FindWrongScripts : EditorWindow
{
	...
	[MenuItem("Alpines/Utilities/FindWrongScripts")]
	static void Init()
	{
	...
	public void OnGUI()
	{
		...
		if(GUILayout.Button("Find Wrong Scripts"))
		{
			FindWrongScriptsInGO(SelectedObject);
		}
